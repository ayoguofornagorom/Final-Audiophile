...
// - createOrder(anyone)
// - getUsersOrders (Logged-in user sees their own orders)
...
export const getDashboardStats = async (
  ...
  try {
    // Run multiple database queries in parallel using Promie.all
    ...
    // Mostly revenue for the past 6 months
    ...
    const monthlyRevenue = await Order.aggregate([
      ...
      },
      {
        ...
        $group: {
          ...
          const: { $sum: 1 }, // count of orders that month
        },
      },
