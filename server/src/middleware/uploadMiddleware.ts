...
// Multer is a Node.js middleware for handling multiparts/form data/uploads to third-party websites etc
...
const fileFilter = (
  ...
  // Check if the file MIME type starts with "image/" e.g, "image/jpeg", "image/png", "image/webp"
