    ...
    <header className="bg-[#131313] relative overflow-hidden ">
      <div className="px-6 sm:px-[clamp(1rem,11.40vw,200px)]">
        <div className="flex flex-col lg:flex-row items-center justify-between min-h-132 md:min-h-182.25 lh:min-h-157.75 py-16 md:py-20 lg:py-0 relative ">
          ...
          <div className="lg:flex md:flex w-full lg:w-[55%] right-20 md:right-0 -top-15 lg:-top-23.75 lg:right-17.5 z-0 mt-8 lg:mt-0 md:-top-30.5 absolute ">
            <img
              src={heroImg}
              alt=""
              className="max-w-125 lg:max-w-none mx-auto lg:mx-0 z-0 md:max-w-170 "
            />
          </div>
        </div>
      </div>
