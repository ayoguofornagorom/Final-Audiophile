        ...
        <div className="bg-white rounded-2xl p-8 md:p-12 shadow-sm">
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4">
            <button
              onClick={handleSave}
              disabled={isSaving}
              className="bg-[#D87D4A] text-white font-bold text-[13px] tracking-[1px] uppercase px-8 py-4 hover:bg-[#FBAF85] transition-colors duration-200 cursor-pointer flex-1 text-center  disabled:opacity-60 disabled:cursor-not-allowed"
            >
