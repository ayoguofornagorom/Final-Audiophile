      ...
      <div className="page-padding">
        ...
        {!error && orders.length === 0 && (
          <div className="bg-white rounded-2xl p-12 text-center">
            ...
            <Link to="/" className="bg-[#D87D4A] text-white font-bold text-[13px] tracking-[1px] uppercase  hover:bg-[#FBAF85] transition-colors duration-200 cursor-pointer inline-block py-4 px-8">
              Shop Now
            </Link>
          </div>
        )}
