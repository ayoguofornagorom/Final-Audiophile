...
const ProductDetailPage: React.FC = () => {
  ...
  if (!product) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center gap-4 bg-[#FAFAFA]">
        ...
        <button
          onClick={() => navigate(-1)}
          className="bg-[#D87D4A] text-white font-bold text-[13px] tracking-[1px] uppercase  py-4 px-8 hover:bg-[#FBAF85] transition-colors duration-200 cursor-pointer"
        >
          Go Back
        </button>
      </div>
  ...
  return (
    <div className="bg-[#FAFAFA] animate-fadeIn">
      ...
      <section className="sm:px-[clamp(1rem,11.40vw,200px)] mt-6 md:mt-10">
          ...
          <div className="w-full lg:flex-1 flex flex-col items-center lg:items-start text-center lg:text-left gap-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                className="bg-[#D87D4A] text-white font-bold text-[13px] tracking-[1px] uppercase  py-4 px-8 hover:bg-[#FBAF85] transition-colors duration-200 cursor-pointer h-12"
              >
                Add to Cart
              </button>
            </div>
      ...
      {/* ---- Features + In the Box ---- */}
      <section className="sm:px-[clamp(1rem,11.40vw,200px)] mt-20 md:mt-28 lg:mt-40">
      ...
      {alsoLikeProducts.length > 0 && (
        <section className="page-padding mt-20 md:mt-28 lg:mt-40">
