...
const NotFoundPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] flex flex-col">
      {/* Minimal navbar */}
      <div className="bg-black py-6 sm:px-[clamp(1rem,11.40vw,200px)]">
        <Link to="/">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-20 text-center">
        ...
        <div className="-mt-8 md:-mt-12 flex flex-col items-center gap-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-4">
            ...
            <Link to="/">
              <button className="bg-[#D87D4A] text-white font-bold text-[13px] tracking-[1px] uppercase  py-4 px-8 hover:bg-[#FBAF85] transition-colors duration-200 cursor-pointer">
                Back to Home
              </button>
            </Link>
          </div>
